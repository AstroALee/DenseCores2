...
# INPUTS
# ----
# python contour.py filename A Y/N Log # B #
...
idxS = str(sys.argv[2])
idx = -1
if(idxS=='0'): idx = 0 # r indx
if(idxS=='1'): idx = 1 # z indx
if(idxS=='2'): idx = 2 # r pos
if(idxS=='3'): idx = 3 # z pos
if(idxS=='4' or idxS.lower()=='v'): idx = 4 # V
if(idxS=='5' or idxS.lower()=='a'): idx = 5 # A
if(idxS=='6' or idxS.lower()=='q'): idx = 6 # Q
if(idxS=='7' or idxS.lower()=='rho'): idx = 8 # rho
if(idxS=='8' or idxS.lower()=='phi'): idx = 9
...
ContLog = 0
if(str(sys.argv[4]).lower()=='y'): ContLog = 1

NCont = 2
if(int(sys.argv[5])>2): NCont = int(sys.argv[5])
...
if(idx==9): PlotMe = multiply(Rpos,data[5,:]) # Phi = r*A
...
NBCont = 1
if( len(sys.argv) > 5 ):
    if(sys.argv[6].upper()=='Y'):
        Bfield = 'Y'
        if( len(sys.argv) > 5 and int(sys.argv[7]) > 1): NBCont = int(sys.argv[7]) # will plot min, at least
